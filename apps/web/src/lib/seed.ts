...
import "./env";
import { migrateLegacyRun } from "./state-migration";

const createdAt = "2026-08-26T09:00:00.000Z";

const seedRun = { ...migrateLegacyRun({ id: "run_seed", projectId: "prj_pmstudio", status: "completed", costUsd: 0.018, durationMs: 6840, demoMode: true, workflowMode: "structured", createdAt: "2026-08-26T10:00:01.000Z", completedAt: "2026-08-26T10:00:08.000Z", steps: [
...
]}), userMessageId: "msg_1" } as StudioState["runs"][number];
